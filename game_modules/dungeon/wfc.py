...
class NodeGrid:
    def __init__(self, size, ruleset: RuleSet = RuleSet(input_sample), seed=random.randint(0, 100)):
    ...
    def pregenerate(self, grid, wrap=False):
        ...
        for node_type in node_types:
            node = None
            while node is None:
                check = grid[random.randint(3, self.width - 4)][random.randint(3, self.height - 4)]
